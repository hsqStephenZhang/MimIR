...
void init_world(nb::module_& m) {
    ...
    nb::class_<World>(m, "World", nb::never_destruct())
        ...
        .def("type_nat", [](World& w) -> const Def* { return w.type_nat(); }, nb::rv_policy::reference_internal)
        .def("lit_nat", &World::lit_nat, nb::rv_policy::reference_internal)
        ...
        .def("sigma", [](World& w, DefVector ops) { return w.sigma(Defs(ops)); }, nb::rv_policy::reference_internal)
        .def("mut_sigma", [](World& w, size_t size) { return w.mut_sigma(size); }, nb::rv_policy::reference_internal)
        .def("mut_sigma", [](World& w, const Def* type, size_t size) { return w.mut_sigma(type, size); }, nb::rv_policy::reference_internal)
        .def("tuple", [](World& w, DefVector ops) { return w.tuple(Defs(ops)); }, nb::rv_policy::reference_internal)
