...
The closed-table decoder recognizes `lo > hi` and drops those slots before
residual code is generated.
...
4. Drops statically empty padding ranges and emits checks for live transitions.
